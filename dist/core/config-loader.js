...
const v1_0_1_json_1 = __importDefault(require("../../config/versions/testnet/v1.0.1.json"));
const common_1 = require("../types/common");
class ConfigLoader {
    static loadNetworkConfig(network) {
        let networkConfig = networks_json_1.default[network];
        let packageConfigData = network == common_1.Network.Mainnet ? v1_0_0_json_1.default : v1_0_1_json_1.default;
        return {
